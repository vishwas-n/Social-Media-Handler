...
def my_form():
    ...
    if (not register_flag):
        register_flag = True
        # requests.post(url='http://localhost:8990/register_subscriber')
...
def my_form_post():
    ...
    if (checkboxes != []):
        ...
        try:
            # requests.post(url='http://localhost:8990/subscriber/subscribe', params=topics)
            requests.post(url='http://' + broker + ':8990/subscriber/subscribe', params=topics)
    ...
    if (undo_checkboxes != []):
        ...
        try:
            ...
            # requests.post(url='http://localhost:8990/subscriber/unsubscribe', params=undo_topics)
